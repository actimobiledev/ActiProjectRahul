...
public class AcceptedJobs {
    ...
    String job_id,title,snippet,country,skill,status,budget,job_url;

    public AcceptedJobs(int id, String job_id, String title, String budget , String snippet, String country, String skill, String status , int job_post, int job_hire, String job_url) {
        this.id = id;
        this.job_id = job_id;
        this.title = title;
